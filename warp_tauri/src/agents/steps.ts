...
export function generateMasterPlan(planId: string) {
  const steps: PlanStep[] = [
    // Step 1: Audit current system
    {
      ...
      description: 'Analyze existing MLX, Claude integration, UI, debug logs, and execution plan system.',
      tool: 'mlx',
      ...
      substeps: [
        {
          ...
          description: 'Ensure Local (MLX), Claude, Auto, Hybrid modes are functioning correctly.',
          tool: 'mlx',
          requiresApproval: false,
          status: 'pending',
        },
    ...
    // Step 9: Helper Modules
    {
      ...
      substeps: [
        ...
        },
        {
          ...
          description: 'Enhance MLX local streaming for large outputs',
          tool: 'claude',
          requiresApproval: false,
          status: 'pending',
        },
      ...
      substeps: [
        {
          ...
          description: 'MLX generates summary of current auth implementation',
          tool: 'read_file',
      ...
      substeps: [
        {
          ...
          description: 'MLX generates test suite for JWT service',
          tool: 'mlx',
          requiresApproval: false,
          status: 'pending',
        },
